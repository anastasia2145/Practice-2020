...
for min_samples_split in min_samples_splits:
    ...
    print("Finished {} in time {} minutes  train_rmse:  {}  test_rmse  {}".format(min_samples_split, (time.time()-start)/60, train_results[-1], test_results[-1])) 
...
# plt.show()
plt.savefig('plots/min_samples_splits_reg.png')
